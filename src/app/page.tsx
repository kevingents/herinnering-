...
const PLANS: {
...
}[] = [
  {
    name: "Start",
    price: "Gratis",
    tagline: "Voor wie wil beginnen met herinneringen vastleggen",
    features: ["AI-interviews", "Foto's & audio opslaan", "Persoonlijke levenslijn"],
  },
  {
    name: "Family",
    price: "€9 / maand",
    tagline: "Voor gezinnen die samen een familiearchief willen bouwen",
    features: ["Alles van Start", "Familieleden uitnodigen", "Gezamenlijke herinneringen", "Tijdcapsules"],
    featured: true,
  },
  {
    name: "Legacy",
    price: "Eenmalig",
    tagline: "Voor families die generaties lang willen bewaren",
    features: ["Alles van Family", "Uitgebreide privacy-opties", "Generaties behouden", "Prioriteit support"],
  },
];
...
export default function EverloomHome() {
  return (
      ...
      <section className="mx-auto grid max-w-6xl items-center gap-12 px-6 py-16 lg:grid-cols-[1.05fr_0.95fr] lg:py-24">
        <Reveal className="flex flex-col gap-7">
          ...
          <p className="max-w-xl font-meta text-lg leading-relaxed text-cream-ink/75">
            Everloom helpt je om herinneringen, foto&apos;s, video&apos;s,
        ...
        <div className="mx-auto max-w-6xl px-6">
          <Reveal className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 font-meta text-lg text-cream-ink/70">
              Met Everloom bouw je stap voor stap een persoonlijk familiearchief.
            </p>
          </Reveal>
              ...
              >
                ...
                <div className="mt-auto flex items-center gap-2 rounded-xl bg-cream/10 px-4 py-3">
                  ...
                  <span className="font-meta text-sm text-cream/85">
                    Jouw verhaal is veilig bij Everloom.
                  </span>
                </div>
              </div>
            </Reveal>
              ...
              <Reveal key={p.name} delay={i * 0.07}>
                ...
                >
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="font-meta text-sm text-bronze">{p.price}</span>
                  </div>
                  <p className="font-meta text-[0.95rem] leading-relaxed text-cream-ink/70">
                    {p.tagline}
                  </p>
                  <ul className="flex flex-col gap-2.5">
                    {p.features.map((f) => (
                      <li key={f} className="flex items-center gap-2.5">
                        ...
                        <span className="font-meta text-sm text-cream-ink/80">
                          {f}
                        </span>
                      </li>
                    ))}
