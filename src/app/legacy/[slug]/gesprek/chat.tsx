...
import { askInApp, type ChatTurn } from "./actions";
import { Slab } from "@/components/ui/slab";

const STARTERS = [
  "Hoe was je jeugd?",
  "Wat vond je echt belangrijk?",
  "Vertel over een mooie herinnering.",
];
...
export function LegacyChat({
  ...
  async function send(question: string) {
    ...
    const res = await askInApp(legacyId, q, history);
    ...
    <Slab featured className="flex flex-col p-6 sm:p-8">
      ...
      >
        ...
        <button
          ...
          aria-label="Verstuur"
          className="inline-flex size-12 shrink-0 items-center justify-center rounded-full bg-forest text-cream transition-all hover:brightness-105 disabled:opacity-40"
        >
