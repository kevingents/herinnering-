...
- ✅ Backend-fundament als code (schema, RLS, Supabase-clients, typed env)
- ⏳ Auth-flow, dashboard, en de features (levenslijn, interview, grafmodus, …)
- ⏳ Live database + AI-laag (wacht op secrets)
